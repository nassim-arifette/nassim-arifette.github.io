...
date: "2023-05-03"
description: "MFCCs vs. Mel spectrograms for frame-level voiced/unvoiced detection with a small CNN—compact cepstra outperform higher-dimensional inputs on limited data."
tags: ["Audio","Speech","Voiced/Unvoiced","MFCC","Mel Spectrogram","CNN","TensorFlow","Librosa"]
links: { pdf: "/ter_report_voiced_unvoiced.pdf" }
---
...
<strong><a href="/ter_report_voiced_unvoiced.pdf" className="btn btn--primary no-underline">Read the full report (PDF)</a></strong>
